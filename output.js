...
return if_(operator == TokenType.slash(), (function() {
return Type.constructor(position, "Float@_", []);
}), (function() {
return operandType;
}));
}), (function() {
...
emitTerm(builder, value);
return builder.append(")");
})), Pair.pair("Int@_.remainder", (function(value, builder, arguments_) {
builder.append("(");
emitTerm(builder, value);
builder.append(" % ");
emitArguments(builder, arguments_);
...
emitTerm(builder, value);
return builder.append(")");
})), Pair.pair("Float@_.round", (function(value, builder, arguments_) {
builder.append("Math.round(");
emitTerm(builder, value);
return builder.append(")");
})), Pair.pair("Float@_.floor", (function(value, builder, arguments_) {
builder.append("Math.floor(");
emitTerm(builder, value);
return builder.append(")");
})), Pair.pair("Float@_.ceil", (function(value, builder, arguments_) {
