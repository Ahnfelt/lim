...
methodCall: function(position, value, name, arguments_, hintSymbol) { return {
_: "methodCall",
position: position,
value: value,
name: name,
...
match: function(position, value, cases, hintSymbol) { return {
_: "match",
position: position,
value: value,
cases: cases,
...
// () => StringMap[F3[Term, StringBuilder, Arguments, Void]]
...
if(window.compilesOfKeen == null) window.compilesOfKeen = 1; else window.compilesOfKeen += 1;
if(window.compilesOfKeen < 3) { var globalEval = eval; globalEval(emitted); window.doCompileKeenNow(); } else console.log(emitted);
}
...
// StringMapBuilder[_3767]
var variables = newStringMapBuilder([]);
// StringMapBuilder[_3772]
...
// Pair[Array[MethodSignature?], String]?
...
// StringMapBuilder[_5849]
var definedTypes = newStringMapBuilder([]);
// StringMapBuilder[_5854]
...
// StringMapBuilder[_5972]
var variables = newStringMapBuilder([]);
// StringMapBuilder[_5977]
